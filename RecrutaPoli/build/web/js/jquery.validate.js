...
$(function() {
    ...
    /* Required message */
    var requiredMsg = "<br>Esta informa&ccedil;&atilde;o &eacute; necess&aacute;ria.";    
	/*Radio Mensagem*/
	var radioMsg = "<br>Selecione uma op&ccedil;&atilde;o.";
	/*Checkbox Mensagem*/
	var chkMsg = "<br>Marque uma op&ccedil;&atilde;o.";
    /* E-mail message */
    var mailMsg = "<br>O e-mail informado &eacute; inv&aacute;lido.";
    /* CPF message */
    var cpfMsg = "<br>CPF informado &eacute; inv&aacute;lido.";
    /* cnpj message */
    var cnpjMsg = "<br>CNPJ informado &eacute; inv&aacute;lido.";
    /* Data message */
    var dataMsg = "<br>Data informada &eacute; inv&aacute;lida.";    
    /* Numeric message */
    var numericMsg = "<br>O valor deve ser num&eacute;rico.";
    /* minlength message */
    var minMsg = "<br>Informe ao menos X caracteres.";
    /* maxlength message */
    var maxMsg = "<br>A quantidade m&aacute;xima &eacute; de X caracteres.";
    /* Password message */
    var passwordMsg = "<br>Senhas n&atilde;o conferem.";
    /* Telefone message */
    var foneMsg = "<br>O telefone informado &eacute; inv&aacute;lido.";    
